 ...
 * Postings are loaded and stored in-memory
 * 
 * @author dayuyuan
 * 
 */
public class FeatureWrapperSimpleImpl implements FeatureWrapperInterface, Serializable {

	private static final long serialVersionUID = -8803426884427598546L;
	private OneFeatureMultiClass feature;
	private int[][] postings;

	public FeatureWrapperSimpleImpl(int fID, Graph g, int[] containedDB,
	...
	public FeatureWrapperSimpleImpl(PostingFeaturesMultiClass features, int fID) {
	 ...
	 *            :
	 */
	public FeatureWrapperSimpleImpl(OneFeatureMultiClass feature2,
			int[][] thePostings) {
